"""Command-line interface for SevenNet inference"""
...
def create_parser():
    """Create argument parser for SevenNet CLI."""
    parser = argparse.ArgumentParser(
        description="SevenNet Inference - High-level CLI for SevenNet force field calculations",
    ...
    sp_parser.add_argument('--model', default='7net-0', help='SevenNet model name or path')
    ...
    opt_parser.add_argument('--model', default='7net-0', help='SevenNet model')
    ...
    md_parser.add_argument('--model', default='7net-0', help='SevenNet model')
    ...
    phonon_parser.add_argument('--model', default='7net-0', help='SevenNet model')
    ...
    bulk_parser.add_argument('--model', default='7net-0', help='SevenNet model')
    ...
    batch_parser.add_argument('--model', default='7net-0', help='SevenNet model')
...
def main():
    ...
    from sevennet_inference.utils.io import read_structure, write_structure
...
def execute_single_point(args):
    ...
    calc = SevenNetInference(model=args.model, device=args.device)
...
def execute_batch_optimize(args):
    ...
    from sevennet_inference import SevenNetInference
    from sevennet_inference.utils.io import read_structure
    from pathlib import Path
